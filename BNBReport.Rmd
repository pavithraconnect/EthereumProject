...
We will be using the same token that we used for study in the previous projects.
...
Using the 4 features mentioned above we can observe that the regression model predicts the price on a particular day t based on the prices of day t-1.

The github repository for the project can be found at https://github.com/pavithraconnect/EthereumProject
